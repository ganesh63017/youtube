          ...
          <SideBarContainer>
            <NavItemsContainer>
              ...
              >
                <NavLink
                  to="/"
                  color={activeTab === 'HOME' ? 'black' : {bgColor}}
                >
                  <AiFillHome />
                  <ItemText
                    color={activeTab === 'HOME' ? 'black' : {textColor}}
                  >
                    Home
                  </ItemText>
                </NavLink>
              ...
              >
                <NavLink
                  to="/trending"
                  color={activeTab === 'TRENDING' ? 'black' : {textColor}}
                >
                  <AiFillFire />
                  <ItemText
                    color={activeTab === 'TRENDING' ? 'black' : {bgColor}}
                  >
                    Trending
                  </ItemText>
                </NavLink>
              ...
              >
                <NavLink
                  to="/gaming"
                  color={activeTab === 'GAMING' ? 'black' : {textColor}}
                >
                  <SiYoutubegaming />
                  <ItemText
                    color={activeTab === 'GAMING' ? 'black' : {bgColor}}
                  >
                    Gaming
                  </ItemText>
                </NavLink>
              ...
              >
                <NavLink
                  to="/saved-videos"
                  color={activeTab === 'SAVED VIDEOS' ? 'black' : {textColor}}
                >
                  <MdPlaylistAdd />
                  <ItemText
                    color={activeTab === 'SAVED VIDEOS' ? 'black' : {bgColor}}
                  >
                    Saved videos
                  </ItemText>
                </NavLink>
